...
insert into movies(movie_id,movie_title,release_year,director_id) values(111,'Ravanasura',2022,234),(222,'Love Today',2022,5576),(333,'Raja Rani',2011,2345),(444,'Andala Rakshasi',2011,234),(555,'Bigil',2019,2345),(666,'Raja The Great',2017,5901),(777,'openheimar',2023,5576);
create table directors(director_id int primary key,director_name varchar(50));
insert  into directors( director_id,director_name) values(234,'sudheer varma'),(5576,'Pradeep Ranganathan'),(2345,'Atlee Kumar'),(5901,'Anil Ravipudi');
